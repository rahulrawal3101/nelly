...
import banner21 from '../assets/banner21.webp';
...
const HeaderComp = () => {
  return (
    ...
    {/* <Grid container sx={{ p:{lg:'10px 0px', md:'10px 0px', sm:'0px', xs:'0px'}, justifyContent:'space-between', }}>
        <Grid item xs={5.95}  sx={{ height:{lg:'230px', md:'230px', sm:'170px',xs:'90px'}}}>
    ...
    <Grid container sx={{ p:'10px', justifyContent:'space-between', mt:'30px', mb:'10px'}}>
        <Grid item xs={12} sx={{height:{lg:'340px', md:'230px', sm:'170px',xs:'150px'}, backgroundImage:`url(${banner21})`, backgroundSize:'100% 100%', backgroundRepeat:'no-repeat', }}>
            {/* <img src={banner21} style={{width:'100%', height:'100%'}}/> */}

        </Grid>

        {/* <Grid item xs={5.95} sx={{height:{lg:'270px', md:'230px', sm:'170px',xs:'110px'}}}>
